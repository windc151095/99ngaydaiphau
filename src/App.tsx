        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative group/pain">
            ...
            {[
              ...
              { icon: Link, title: "6. Hy sinh độc hại", desc: "Đầu tắt mặt tối lo cho gia đình, nhà cửa gọn gàng, cơm nước tươm tất nhưng khuôn mặt luôn cau có, lời nói đầy đay nghiến. Bạn nghĩ mình đang hy sinh, nhưng thực chất đang \"đầu độc\" không khí gia đình bằng năng lượng oán trách?" },
